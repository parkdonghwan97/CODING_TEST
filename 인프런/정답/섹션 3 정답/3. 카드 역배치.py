...
'''
#### 실패 ==== 정답 확인                
# 생각해보니 파이썬은 tmp를 따로 안써도됨;;;;; a ,b = b ,a  이렇게 사용 가능


a  = list(range(21)) # 0부터 20까지 리스트화가 됨   [i for i in range(21)]

for _ in range(10):         # 변수가 없음 10번 입력받음 
    s, e = map(int,input().split())

    for i in range((e-s+1)//2) :    # 교환 횟수
